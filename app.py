...
# ====================================================================================
# KHU VỰC 1: TRẠNG THÁI VNINDEX & DỮ LIỆU THỰC TẾ DNSE (CHỐT 1,732.02)
# ====================================================================================
...
with c1:
    ...
    # Xây dựng chuỗi giá thực chiến bám sát nhịp biến động thực tế và chốt chính xác 1,732.02
    np.random.seed(42)
...
with c2:
    st.markdown("##### 📌 Thuyết minh vĩ mô chuẩn 3 pha & Multi-MA:")
    st.markdown("""
    * **Thời điểm giám sát:** Phiên giao dịch ngày 18/08/2026
    * **Pha 1 (Cấu trúc Multi-MA):** <span style='color:#3b82f6; font-weight:bold;'>ĐH Điều chỉnh kỹ thuật (Test cung)</span> trên nền xu hướng tăng trung hạn.
...
with col_inf2:
    ...
    * **Tick-Volume Proxy:** Nhận diện lệnh mua chủ động giúp phát hiện chân sóng sớm trước khi bứt phá.
    """)
